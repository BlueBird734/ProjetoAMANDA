...
Partial Class HeroisDaFauna
    Inherits System.Web.UI.Page


    Private ReadOnly txtNome As Object
    Private ReadOnly ddlCategoria As Object
    Private ReadOnly txtDescricao As Object
    Private ReadOnly lblMensagem As Object
    ...
    Protected Sub WriteFileCadHerois_Click(sender As Object, e As EventArgs)
        Response.WriteFile("cadHerois.aspx")

    End Sub

    Protected Sub btnModuloDeInscricao_Click(sender As Object, e As EventArgs) Handles btnModuloDeIncricao0.Click
